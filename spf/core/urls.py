...
urlpatterns = [
    ...
    path('package/download', views.package_download_page, name='package_download'),
    ...
    path('user/activity/list', views.user_activity_list_page, name='user_activity_list'),
    path('user/package/upload', views.package_upload_page, name='user_package_upload'),
    path('user/package/download', views.package_download_page, name='user_package_download'),
